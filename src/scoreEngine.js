export const subjects = [
  ...
  },
  {
    ...
    description: 'Free AP Calculus AB score calculator for 2026. Estimate AP Calc AB MCQ and FRQ points with composite, cutoff, and gap-to-5 guidance.',
    aliases: ['ap calc ab score calculator', 'ap calculus ab score calculator', 'ap calculus ab calculator'],
    group: 'stem',
    priorityReason: 'Semrush-backed alias target for AP Calculus AB calculator searches.',
    relatedSlugs: ['ap-statistics', 'ap-physics-1', 'ap-chemistry'],
    faqKeywords: ['ap calc ab score calculator', 'ap calculus ab score calculator', 'ap calculus ab calculator'],
    sections: [
